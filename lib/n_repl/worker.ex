defmodule NRepl.Worker do
  ...
  def send(nrepl_pid, message), do: Connection.call(nrepl_pid, {:send, message})

  def recv(nrepl_pid, bytes \\ 10000, timeout \\ 3000) do
    Connection.call(nrepl_pid, {:recv, bytes, timeout})
  end
